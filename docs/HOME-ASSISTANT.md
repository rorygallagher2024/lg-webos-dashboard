...
| `update` | `update.lg_tv_server_update` | Server Update | Latest release, its notes and an install button. Published only with `"update": { "check": true }` set &mdash; see [Updating](../README.md#updating) |
